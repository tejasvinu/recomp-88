...
export const metadata: Metadata = {
  title: "Recomp 88",
  description: "7-day body recomposition workout tracker with exercise wiki and progress charts",
  applicationName: "Recomp 88",
  appleWebApp: {
    capable: true,
    title: "Recomp 88",
      ...
      <body suppressHydrationWarning>
        <AuthProvider session={session}>
          ...
          <div id="splash-screen">
            ...
            <img src="/icon-512.png" alt="Recomp 88 Logo" className="splash-logo" />
            <div className="splash-title">Recomp 88</div>
